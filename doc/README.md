...
For API usage refer to the Swagger UI / OpenAPI and by inspection of the Arealeditering client network traffic.

## Environments

Two environments are available, demo and production.
